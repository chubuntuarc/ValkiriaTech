<div class="parallax-container valign-wrapper" style="height:850px;">
    <div class="section no-pad-bot">
        <div class="container">
            <div class="row center">
                <div class="slider__warpper">
                    <!-- <div class="flex__container flex--pikachu animate--start" data-slide="1">
                        ...
                        <img class="pokemon__img" src="http://www.whurk.co.uk/wp-content/uploads/revslider/engineering/warehouse-man.png" />
                    </div>
                    ...
                    <div class="flex__container flex--blaziken flex--active" data-slide="3">
                        <div class="flex__item flex__item--left">
                            ...
                            <p class="text__background">Inventarios</p>
                        </div>
                        <div class="flex__item flex__item--right"></div>
                        <img class="pokemon__img" src="../img/inventory.png" />
                    </div>
                    <div class="flex__container flex--dialga animate--start" data-slide="4">
                        <div class="flex__item flex__item--left">
                            ...
                            <div class="flex__item flex__item--right"></div>
                            <img class="pokemon__img" src="../img/doctor.png" />
                        </div>
                        ...
                        <div class="slider__navi">
                            ...
                            <a href="#" class="slide-nav active" data-slide="3">blaziken</a>
